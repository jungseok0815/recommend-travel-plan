...
def create_preference(db: Session, user_id: int, preference_data: PreferenceCreate) -> PreferenceResponse:
    ...
    preference = Preference(
        user_id          = user_id,
        travel_style     = preference_data.travel_style,
        environment      = preference_data.environment,
        accommodation    = preference_data.accommodation,
        interest         = preference_data.interest,
...
def update_preference(db: Session, user_id: int, preference_data: PreferenceCreate) -> PreferenceResponse:
    ...
    preference.travel_style     = preference_data.travel_style
    preference.environment      = preference_data.environment
    preference.accommodation    = preference_data.accommodation
    preference.interest         = preference_data.interest
